    ...
    class AffairView < View
      ...
      def view_list_page(num = nil)
        begin
          ...
          ERB.new(self.load_static_file('page.rhtml', 'affair')).result(@api.ct_list_page(num).get_binding)
      ...
      def view_list_details(num = nil)
        begin
          ...
          ERB.new(self.load_static_file('details.rhtml', 'affair')).result(_e.get_binding)
